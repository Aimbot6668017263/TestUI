    ...
    local function AddDropdown(tabData, labelText, options, defaultOption, callback)
        ...
        local function openDropdown()
            ...
            if not listFrame then
                ...
                listFrame = CreateFrame(ContentArea, UDim2.new(0, 10, 0, listHeight), UDim2.new(0, 0, 0, 0), Theme.ElementBG, "DropdownList")
            ...
            local selectButtonAbsolutePosition = selectButton.AbsolutePosition
            local contentAreaAbsolutePosition = ContentArea.AbsolutePosition
            local relativeX = selectButtonAbsolutePosition.X - contentAreaAbsolutePosition.X
            local relativeY = selectButtonAbsolutePosition.Y - contentAreaAbsolutePosition.Y + selectButton.AbsoluteSize.Y + 4
            local listHeight = math.min(#options, 5) * 34 + 8
            listFrame.Position = UDim2.new(0, relativeX, 0, relativeY)
            listFrame.Size = UDim2.new(0, selectButton.AbsoluteSize.X, 0, listHeight)
    ...
    local function AddMultiSelect(tabData, labelText, options, defaultOptions, callback)
        ...
        local function openMultiSelect()
            ...
            if not listFrame then
                ...
                listFrame = CreateFrame(ContentArea, UDim2.new(0, 10, 0, listHeight), UDim2.new(0, 0, 0, 0), Theme.ElementBG, "MultiSelectList")
                CreateCorner(listFrame, 9)
                CreateStroke(listFrame, Theme.Border, 1)
                listFrame.ZIndex = 20
                CreateListLayout(listFrame, 2)
